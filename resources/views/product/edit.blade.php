            ...
            <form class="form-horizontal" method="POST" action="/products/update">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" placeholder="Title" name="name" value="{{$product->name}}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="color" placeholder="Colour" name="color" value="{{$product->color}}">
                        </div>
                    </div>
                    <div class="form-group">
